...
import { d as renderElement, g as generateCspDigest, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, e as createHeadAndContent, r as renderComponent } from './prerender_q-TdbtyM.mjs';
import { c as createComponent } from './BaseLayout_C4vdHwqn.mjs';
import 'clsx';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CNxxFcE6.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_DC8qXn_w.mjs').then(n => n._);
